...
{
    class BE_AccesoDatos_T
    {
        public enum EstadoTransaccion { error, correcto }
        public enum TipoConexion { simple, transaccion }

        string CadenaConexion = "Data Source=200.69.137.167,11333;Persist Security Info=True;User ID=BD3K6G12_2021;Initial Catalog=BD3K6G12_2021;password=BDG12_8214";
